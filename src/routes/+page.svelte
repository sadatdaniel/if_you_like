<div class="grid grid-cols-1 md:grid-cols-2 h-full">
		...
		<div class="relative">
			...
			>
				<div class="overflow-y-auto divide-y">
					...
					<div
						class="flex items-center justify-center w-12 h-12 bg-yellow-500 text-white rounded-full"
					>
	...
	<div class="relative p-20 bg-yellow-300">
		...
		<div class="absolute bottom-0 right-0 text-gray-800 p-4">
			<p class="text-end">Powered by ChatGPT & Svelte</p>
